...
Protected Class SelectFolderDialog
	...
	#tag Method, Flags = &h0
		Function ShowModal() As FolderItem
		  ...
		  if ShowEditBox then flags=kBIF_EDITBOX
		  result=SelectFolder(PromptText,InitialDirectory,Flags)
		  Return Result
		End Function
	#tag EndMethod
	...
	#tag Property, Flags = &h0
		InitialDirectory As SelectFolderDialog.RootFolders
	#tag EndProperty
	...
	#tag Enum, Name = RootFolders, Type = Integer, Flags = &h0
